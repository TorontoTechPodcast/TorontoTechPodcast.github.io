      ...
      $("#jplayer_11").jPlayer({
        ready: function () {
          $(this).jPlayer("setMedia", {
            title:"Episode 11",
              artist:"",
              mp3:"episodes/ttp-episode11-lets-make-toronto.mp3"
          });
        },
        play: function() { // To avoid multiple jPlayers playing together.
          $(this).jPlayer("pauseOthers");
      ...
      $("#jplayer_12").jPlayer({
        ready: function () {
          $(this).jPlayer("setMedia", {
            title:"Episode 12",
              artist:"",
              mp3:"episodes/ttp-episode12-the-man-who-brought-internet-to-toronto.mp3"
          });
        },
        play: function() { // To avoid multiple jPlayers playing together.
          $(this).jPlayer("pauseOthers");
      ...
      $("#jplayer_13").jPlayer({
        ready: function () {
          $(this).jPlayer("setMedia", {
            title:"Episode 13",
              artist:"",
              mp3:"episodes/ttp-013-data-science-will-change-your-business.mp3"
          });
        },
        play: function() { // To avoid multiple jPlayers playing together.
          $(this).jPlayer("pauseOthers");
